package by.bsuir.adam.wt.tasks.first.task13.runner;

import by.bsuir.adam.wt.tasks.first.task12.logic.Book;
import by.bsuir.adam.wt.tasks.first.task13.logic.ProgrammerBook;

import static by.bsuir.adam.wt.tasks.first.scanner.InputData.*;
