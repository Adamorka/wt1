package by.bsuir.adam.wt.tasks.first.task9.runner;

import by.bsuir.adam.wt.tasks.first.scanner.InputData;
import by.bsuir.adam.wt.tasks.first.task9.classes.Ball;
import by.bsuir.adam.wt.tasks.first.task9.classes.Basket;
import by.bsuir.adam.wt.tasks.first.task9.logic.DoTask;
